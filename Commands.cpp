...
void export_commands() {
  ...
  class_<cr::Command::SetACC>("SetACC")
    .def("__init__", &command_impl::CustomInit<ActorPtr, bool>, (arg("actor"), arg("enabled")))
    .def(init<cr::ActorId, bool>((arg("actor_id"), arg("enabled"))))
    .def_readwrite("actor_id", &cr::Command::SetACC::actor)
    .def_readwrite("enabled", &cr::Command::SetACC::enabled)
  ;
  ...
  implicitly_convertible<cr::Command::SetACC, cr::Command>();
}
